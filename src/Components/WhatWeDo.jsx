  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="pt-16 mb-8 text-center text-4xl sm:text-5xl font-bold text-red-800">
          WHAT WE DO
        </h2>

        <p className="mx-auto mb-12 max-w-3xl text-center text-lg text-gray-600">
          Creating lasting change by empowering individuals, strengthening
          communities, and providing sustainable solutions to overcome poverty.
        </p>
